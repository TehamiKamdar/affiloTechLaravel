                    ...
                    <div class="advertiser-card card h-100 border-0 shadow-sm">
                        ...
                        <div class="card-footer pt-0">
                            <div class="row justify-content-around">
                                ...
                                @endphp
                                @if($isNoStatus)
                                    <button class="btn btn-sm {{$class}}" data-toggle="modal"
                                        data-target="#kt_modal_apply_data_{{ $advertiser->id }}" title="Status">
                                        @if($isPending)
                                            Pending
                                        @elseif($isHold)
                                            Hold
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class=" col-12 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="btn btn-close btn-sm bg-danger" data-kt-apply-advertiser-modal-action="close"
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <form class="form w-100" novalidate="novalidate" action="{{ route('publisher.apply-advertiser') }}"
                                    method="post">
                                    @csrf
                                    ...
                                    <p class="font-weight-bold text-black">Optional: Tell us about your promotional methods and
