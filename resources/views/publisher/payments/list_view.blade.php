                ...
                <tr class="border-bottom">
                    ...
                    <td>
                        <div class="btn-group atbd-button-group btn-group-normal" role="group ">
                            ...
                            @endphp
                            <a href="{{ route("publisher.reports.transactions.list") }}?payment_id={{ $payment->id }}&r_name={{ $status }}"
                                type="button" class="btn  btn-xs btn-outline-dark">Transactions</a>
                            @if($payment->status == \App\Models\PaymentHistory::PAID)
                                <a href="{{ route("publisher.payments.invoice", ['payment_history' => $payment->id]) }}"
                                    type="button" class="btn btn-xs btn-outline-dark">Invoice</a>
                            @endif
                        </div>
                    </td>
