        ...
        function clickGraphData(date) {
            fetch('/publisher/clicks-data', {
                ...
                .then(data => {
                    ...
                    clicksChartInstance = new ApexCharts(document.querySelector("#clicksGraph"), options);
                    clicksChartInstance.render();
                })
                .catch(error => {
...
@section('heading_right_space')
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3">
        ...
        <div class="m-0">
            <!--begin::Menu toggle-->
            <a href="{{route('publisher.advertiser-performance')}}" class="btn btn-sm btn-flex btn-secondary fw-bold"
                data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" style="font-size:15px;">
                Advertiser Performance</a>
            <!--end::Menu toggle-->
            <!--begin::Menu 1-->
...
@section('content')
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="">Clicks Performance</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                ...
                <div>
                    <a href="{{route('publisher.advertiser-performance')}}"
                        class="btn btn-sm btn-flex btn-secondary fw-bold" data-kt-menu-trigger="click"
                        data-kt-menu-placement="bottom-end" style="font-size:15px;">
                        Advertiser Performance</a>
                </div>
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    ...
                                    <h5 class="text-dark font-weight-bolder mb-0 mt-3" id="total_click">
                                        {{ \App\Helper\Methods::numberFormatShort($total_clicks) }}
                                    </h5>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-title">
                        <!--begin::Search-->
                        <div class="d-flex align-items-center position-relative flex-grow-1 me-5"
                            ...
                            <input type="text" id="search" data-kt-ecommerce-order-filter="search"
                                class="form-control-sm ps-5" placeholder="Search by ID, name, etc..." />
                    </div>
                    <!--end::Search-->
            ...
            <div class="card-body py-4">
                ...
                <div class="row mt-3">
                    <div class="col-12 col-md-6 d-flex align-items-center justify-content-between">
                        ...
                        <div class="dataTables_info text-sm" id="kt_project_users_table_info" role="status"
                            aria-live="polite">
