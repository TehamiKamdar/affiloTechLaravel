                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route("admin.roles.updates") }}" method="POST"
                            ...
                            @csrf
                            <input type="hidden" placeholder="Enter Permission" class="form-control" name="id" value="{{$role->id}}">
                            <label for="name" style="font-size: 16px;font-weight: 900;margin-top: 8px;">Title</label>
                           <input type="text" placeholder="Enter Role Name" class="form-control" name="name" value="{{$role->name}}">
