                ...
                <td style="width: 25%;">
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input advertiser-checkbox" name="advertisers[{{ $advertiser['id'] }}]"
                                   {{ $advertiser['locked_status'] ? "checked" : ''}} value="true">
                            {{ \Illuminate\Support\Str::limit($advertiser['name'], 50, '...') }}
                        </label>
                    </div>
                </td>
            @endforeach
