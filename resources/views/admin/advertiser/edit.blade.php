...
<div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5>Edit Advertiser</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i
                                    class="feather icon-home"></i></a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Edit Advertiser</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route("admin.advertisers.api.update", ["advertiser" => $advertiser->id]) }}" method="POST"
                              enctype="multipart/form-data" id="userForm">
                            @csrf
                            <div class="row">
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
            <label for="name" class="font-weight-bold text-black">Advertiser Name</label>
            <input type="text" id="name" name="name" class="form-control" value="{{ old('name', $advertiser->name ?? '') }}">
            @if($errors->has('name'))
    ...
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('url') ? 'has-error' : '' }}">
            ...
            <input type="url" id="url" name="url" class="form-control" value="{{ old('url', $advertiser->url ?? '') }}">
            @if($errors->has('url'))
                <em class="invalid-feedback">
                    {{ $errors->first('url') }}
                </em>
    ...
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('primary_region') ? 'has-error' : '' }}">
            <label for="primary_region" class="font-weight-bold text-black">Primary Region</label>
            <select class="js-example-basic-single js-states form-control" id="primary_region" name="primary_region">
                <option value="" disabled selected>Please Select</option>
                @foreach($countries as $country)
                    <option {{ in_array($country['iso2'], $advertiser->primary_regions ?? []) ? "selected" : null }}  value="{{ $country['iso2'] }}">{{ $country['name'] }}</option>
                @endforeach
            </select>
    ...
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('currency_code') ? 'has-error' : '' }}">
            <label for="currency_code" class="font-weight-bold text-black">Currency Code</label>
            <select class="js-example-basic-single js-states form-control" id="currency_code" name="currency_code">
                <option value="" disabled selected>Please Select</option>
                @foreach($countries as $country)
                    @if($country['currency'])
                        <option {{ $country['currency'] == $advertiser->currency_code ?? '' ? "selected" : null }}  value="{{ $country['currency'] }}">{{ $country['currency'] }}</option>
                    @endif
                @endforeach
            </select>
...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('average_payment_time') ? 'has-error' : '' }}">
            <label for="average_payment_time" class="font-weight-bold text-black">Average Payment Time</label>
            <input type="text" id="average_payment_time" name="average_payment_time" class="form-control" value="{{ old('average_payment_time', $advertiser->average_payment_time ?? '') }}">
    ...
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('validation_days') ? 'has-error' : '' }}">
            <label for="validation_days" class="font-weight-bold text-black">Validation Days</label>
            <input type="text" id="validation_days" name="validation_days" class="form-control" value="{{ old('validation_days', $advertiser->validation_days ?? '') }}">
...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('supported_regions') ? 'has-error' : '' }}">
            <label for="supported_regions" class="font-weight-bold text-black">Supported Regions</label>
    ...
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('categories') ? 'has-error' : '' }}">
            <label for="categories" class="font-weight-bold text-black">Categories (Max. 4)</label>
            <div class="atbd-select ">
...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('epc') ? 'has-error' : '' }}">
            ...
            <input type="text" id="epc" name="epc" class="form-control" value="{{ old('epc', $advertiser->epc ?? '') }}">
            @if($errors->has('epc'))
                <em class="invalid-feedback">
                    {{ $errors->first('epc') }}
                </em>
    ...
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('deeplink_enabled') ? 'has-error' : '' }}">
            <label for="deeplink_enabled" class="font-weight-bold text-black">Deeplink Enabled</label>
            <select class="js-example-basic-single js-states form-control" id="deeplink_enabled" name="deeplink_enabled">
                <option value="" disabled selected>Please Select</option>
                <option {{ isset($advertiser->deeplink_enabled) && $advertiser->deeplink_enabled == 1 ? "selected" : null }}  value="1">True</option>
                <option {{ isset($advertiser->deeplink_enabled) && $advertiser->deeplink_enabled == 0 ? "selected" : null }}  value="0">False</option>
            </select>
...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('tags') ? 'has-error' : '' }}">
            ...
            <div class="atbd-select ">
                <input type="text" name="tags" class="form-control" data-role="tagsinput" value="@if($advertiser->tags){{$advertiser->tags }}@endif">
            </div>
            @if($errors->has('tags'))
                <em class="invalid-feedback">
                    {{ $errors->first('tags') }}
    ...
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('offer_type') ? 'has-error' : '' }}">
            <label for="offer_type" class="font-weight-bold text-black">Offer Type</label>
            <input type="text" id="offer_type" name="offer_type" class="form-control" value="{{ old('offer_type', $advertiser->offer_type ?? '') }}">
    ...
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('commission') ? 'has-error' : '' }}">
            <label for="commission" class="font-weight-bold text-black">Commission</label>
            <input type="text" id="commission" name="commission" class="form-control" value="{{ old('commission', $advertiser->commission ?? '') }}">
    ...
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('commission_type') ? 'has-error' : '' }}">
            <label for="offer_type" class="font-weight-bold text-black">Commission Type</label>
            <input type="text" id="commission_type" name="commission_type" class="form-control" value="{{ old('commission_type',  $advertiser->commission_type ?? '') }}">
...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('promotional_methods') ? 'has-error' : '' }}">
            <label for="promotional_methods" class="font-weight-bold text-black">Promotional Method</label>
            <div class="atbd-select ">
...
<div class="row mt-4">
    <div class="col-lg-12">
        <div class="form-group {{ $errors->has('click_through_url') ? 'has-error' : '' }}">
            <label for="click_through_url" class="font-weight-bold text-black">Click Through URL</label>
            <input type="url" id="click_through_url" name="click_through_url" class="form-control" value="{{ old('click_through_url', $advertiser->click_through_url ?? '') }}">
...
<div class="row mt-4">
    <div class="col-lg-12">
        <div class="form-group {{ $errors->has('custom_domain') ? 'has-error' : '' }}">
            ...
            <input type="text" id="custom_domain" name="custom_domain" class="form-control" value="{{ old('custom_domain', $advertiser->custom_domain ?? '') }}">
...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group {{ $errors->has('logo') ? 'has-error' : '' }}">
            ...
            @endif
            <label for="logo_preview" class="font-weight-bold text-black">Logo Preview</label><br />
            <img class="img-thumbnail" src="{{ isset($advertiser->logo) && str_contains($advertiser->logo, "http") ? Storage::url($advertiser->logo) : \App\Helper\Static\Methods::staticAsset(Storage::url($advertiser->logo) ) }}" alt="" >
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group {{ $errors->has('program_policies') ? 'has-error' : '' }}">
            <label for="program_policies" class="font-weight-bold text-black">Program Policies</label>
            <textarea name="program_policies" id="program_policies" cols="30" rows="10" class="form-control">{{ $advertiser->program_policies ?? null }}</textarea>
...
<div class="row mt-4">
    <div class="col-lg-12">
        <div class="form-group {{ $errors->has('short_description') ? 'has-error' : '' }}">
            <label for="short_description" class="font-weight-bold text-black">Short Description</label>
            <textarea name="short_description" id="short_description" cols="30" rows="10" class="form-control">{{$advertiser->short_description ?? null }}</textarea>
...
<div class="row mt-4">
    <div class="col-lg-12">
        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
            ...
            <textarea name="description" id="description" cols="30" rows="10" class="form-control">{{ $advertiser->description ?? null }}</textarea>
