...
function chartjsLineChartForcast(
    selector,
    label = "",
    startGradient = "#ca9a4e12",
    endGradient = "#ca9a4e02",
    bColor = "#20C997",
            ...
            var chart = new Chart(elm, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        // backgroundColor: bgColor,
                        borderColor: bColor,
                        pointHoverBackgroundColor: "#ca9a4e",
    ...
    if (ctx) {
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: dataG,
                    backgroundColor: "#ca9a4e80",
                    hoverBackgroundColor: "#ca9a4e",
                    label: "Gained",
                },
                    // {
                    //   data: dataL,
...
chartJsBarChartThree("mychart8", "#ca9a4e20", "#ca9a4e", "Order");
...
chartJsBarChartFour("mychart13", "#ca9a4e20", "#ca9a4e", "New Deals");
