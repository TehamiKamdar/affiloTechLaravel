    ...
    ! function() {
      ...
      if (e) {
        ...
        var o = (t.size - t.lineWidth) / 2,
          i = function(e, t, a) {
            a = Math.min(Math.max(0, a || 1), 1), r.beginPath(), r.arc(0, 0, o, 0, 2 * Math.PI * a, !1), r.strokeStyle = e, r.lineCap = "round", r
              .lineWidth = t, r.stroke()
          };
        i("#E4E6EF", t.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--bs-success"), t
          .lineWidth, .4)
      }
    }()
  }
  ...
  init: function() {
    ! function() {
      ...
      if (e) {
        ...
        i("#E4E6EF", t.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-danger"), t.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--bs-primary"), t
          .lineWidth, .4)
      }
    }()
  }
      ...
      if (e) {
        var t = function(e) {
          ...
          var t = document.createElement("span"),
            a = "";
          return a += '<img src="' + e.element.getAttribute("data-kt-select2-icon") + '" class="rounded-circle h-20px me-2" alt="image"/>', a += e.text, t
            .innerHTML = a, $(t)
        };
        $(e).select2({
...
var KTTimelineWidget24 = {
  init: function() {
    ...
    (e = document.querySelector("#kt_list_widget_24")) && KTUtil.on(e, '[data-kt-element="follow"]', "click", (function(e) {
      "Following" === this.innerText ? (this.innerText = "Follow", this.classList.add("btn-light-primary"), this.classList.remove("btn-primary"), this
        .blur()) : (this.innerText = "Following", this.classList.add("btn-primary"), this.classList.remove("btn-light-primary"), this.blur())
    }))
  }
};
...
var KTPlayersWidget1 = {
  init: function() {
    KTUtil.on(document.body, '[data-kt-element="list-play-button"]', "click", (function(e) {
      ...
      r.classList.contains("d-none") ? (a.play(), l.classList.add("d-none"), r.classList.remove("d-none")) : (a.pause(), l.classList.remove("d-none"),
        r.classList.add("d-none")), [].slice.call(document.querySelectorAll('[data-kt-element="list-play-button"]')).map((function(e) {
        if (e !== t) {
  ...
  var e = function() {
    ...
    if (e) {
      ...
      t.addEventListener("timeupdate", (function() {
        l.innerHTML = g(t.currentTime), a.value = t.currentTime / t.duration * 100, this.ended && (i.classList.remove("d-none"), s.classList.add(
          "d-none"))
      })), o.addEventListener("click", (function() {
        t.duration > 0 && !t.paused ? (t.pause(), i.classList.remove("d-none"), s.classList.add("d-none")) : t.readyState >= 2 && (t.play(), i
          .classList.add("d-none"), s.classList.remove("d-none"))
        ...
        if (e) {
          var t, a = function() {
            ...
            r.mapPolygons.template.setAll({
                ...
                toggleKey: "active",
                interactive: !0
              }), am5.ColorSet.new(t, {}), r.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))), r.mapPolygons
  ...
  return {
    init: function() {
      ...
      o(r, "#kt_table_widget_14_chart_5", m, !0), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered &&
          r.self.destroy(), o(e, "#kt_table_widget_14_chart_1", i, e.rendered), o(t, "#kt_table_widget_14_chart_2", s, t.rendered), o(a,
            "#kt_table_widget_14_chart_3", n, a.rendered), o(l, "#kt_table_widget_14_chart_4", d, l.rendered), o(r, "#kt_table_widget_14_chart_5", m,
            r.rendered)
      }))
    }
  }
  ...
  return {
    init: function() {
      ...
      o(r, "#kt_table_widget_15_chart_5", m, !0), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered &&
          r.self.destroy(), o(e, "#kt_table_widget_15_chart_1", i, e.rendered), o(t, "#kt_table_widget_15_chart_2", s, t.rendered), o(a,
            "#kt_table_widget_15_chart_3", n, a.rendered), o(l, "#kt_table_widget_15_chart_4", d, l.rendered), o(r, "#kt_table_widget_15_chart_5", m,
            r.rendered)
      }))
    }
  }
  ...
  return {
    init: function() {
      ...
      v(b, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_4", R, !1), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered &&
          r.self.destroy(), o.rendered && o.self.destroy(), i.rendered && i.self.destroy(), s.rendered && s.self.destroy(), n.rendered && n.self
          .destroy(), d.rendered && d.self.destroy(), m.rendered && m.self.destroy(), c.rendered && c.self.destroy(), g.rendered && g.self.destroy(),
          f.rendered && f.self.destroy(), u.rendered && u.self.destroy(), h.rendered && h.self.destroy(), p.rendered && p.self.destroy(), y
          .rendered && y.self.destroy(), _.rendered && _.self.destroy(), b.rendered && b.self.destroy(), v(e, "#kt_stats_widget_16_tab_link_1",
            "#kt_table_widget_16_chart_1_1", w, e.rendered), v(t, "#kt_stats_widget_16_tab_link_1", "#kt_table_widget_16_chart_1_2", T, t.rendered),
          v(a, "#kt_stats_widget_16_tab_link_1", "#kt_table_widget_16_chart_1_3", k, a.rendered), v(l, "#kt_stats_widget_16_tab_link_1",
            "#kt_table_widget_16_chart_1_4", x, l.rendered), v(r, "#kt_stats_widget_16_tab_link_2", "#kt_table_widget_16_chart_2_1", A, r.rendered),
          v(o, "#kt_stats_widget_16_tab_link_2", "#kt_table_widget_16_chart_2_2", C, o.rendered), v(i, "#kt_stats_widget_16_tab_link_2",
            "#kt_table_widget_16_chart_2_3", K, i.rendered), v(s, "#kt_stats_widget_16_tab_link_2", "#kt_table_widget_16_chart_2_4", V, s.rendered),
          v(n, "#kt_stats_widget_16_tab_link_3", "#kt_table_widget_16_chart_3_1", S, n.rendered), v(d, "#kt_stats_widget_16_tab_link_3",
            "#kt_table_widget_16_chart_3_2", U, d.rendered), v(m, "#kt_stats_widget_16_tab_link_3", "#kt_table_widget_16_chart_3_3", M, m.rendered),
          v(c, "#kt_stats_widget_16_tab_link_3", "#kt_table_widget_16_chart_3_4", W, c.rendered), v(g, "#kt_stats_widget_16_tab_link_4",
            "#kt_table_widget_16_chart_4_1", L, g.rendered), v(f, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_2", z, f.rendered),
          v(u, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_3", D, u.rendered), v(h, "#kt_stats_widget_16_tab_link_4",
            "#kt_table_widget_16_chart_4_4", O, h.rendered), v(p, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_1", F, p.rendered),
          v(y, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_2", I, y.rendered), v(_, "#kt_stats_widget_16_tab_link_5",
            "#kt_table_widget_16_chart_5_3", P, _.rendered), v(b, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_4", R, b.rendered)
      }))
    }
  }
}();
  ...
  const l = () => {
      ...
      e.forEach(((e, a) => {
        e.addEventListener("click", (l => {
          ...
          if (o.classList.contains("isOpen")) {
            for (; o.nextSibling && "subtable_template" === o.nextSibling.getAttribute("data-kt-table-widget-4");) o.nextSibling.parentNode
    ...
    i = (t, l) => {
      t.forEach(((r, o) => {
        ...
        s.setAttribute("src", u + r.image + ".png"), n.innerText = r.name, d.innerText = r.description, m.innerText = r.cost, c.innerText = r.qty, g
          .innerText = r.total, r.stock > 10 ? f.innerHTML = '<div class="badge badge-light-success">In Stock</div>' : f.innerHTML =
          '<div class="badge badge-light-warning">Low Stock</div>', 1 === t.length || t.length;
    ...
    s = () => {
      ...
      e.querySelectorAll("tbody tr").forEach((e => {
        e.classList.remove("isOpen"), e.querySelector('[data-kt-table-widget-4="expand_row"]') && e.querySelector(
          '[data-kt-table-widget-4="expand_row"]').classList.remove("active")
      }))
    };
  return {
    init: function() {
  ...
  return {
    init: function() {
      ...
      r && (r.addEventListener("slid.bs.carousel", (function(e) {
        ...
        e.rendered && (e.self.destroy(), e.rendered = !1), t.rendered && (t.self.destroy(), t.rendered = !1), a.rendered && (a.self.destroy(), a
          .rendered = !1), l(e, "#kt_slider_widget_1_chart_1", 76), l(t, "#kt_slider_widget_1_chart_2", 55), l(a, "#kt_slider_widget_1_chart_3",
          25)
      })))
    }
  }
  ...
  return {
    init: function() {
      ...
      o && (o.addEventListener("slid.bs.carousel", (function(e) {
        ...
        e.rendered && (e.self.destroy(), e.rendered = !1), t.rendered && (t.self.destroy(), t.rendered = !1), a(e, "#kt_sliders_widget_3_chart_1",
          "danger", l), a(t, "#kt_sliders_widget_3_chart_2", "primary", r)
      })))
    }
  }
}();
  ...
  return {
    init: function() {
      ...
      r && (r.addEventListener("slid.bs.carousel", (function(e) {
        ...
        e.rendered && (e.self.destroy(), e.rendered = !1), t.rendered && (t.self.destroy(), t.rendered = !1), a.rendered && (a.self.destroy(), a
          .rendered = !1), l(e, "#kt_slider_widget_7_chart_1", 76), l(t, "#kt_slider_widget_7_chart_2", 55), l(a, "#kt_slider_widget_7_chart_3",
          25)
      })))
    }
  }
      ...
      if (t) {
        var a = t.hasAttribute("data-kt-negative-color") ? t.getAttribute("data-kt-negative-color") : KTUtil.getCssVariableValue("--bs-success"),
          ...
          i = {
            ...
            xaxis: {
              categories: ["Jan 5", "Jan 7", "Jan 9", "Jan 11", "Jan 13", "Jan 15", "Jan 17", "Jan 19", "Jan 20", "Jan 21", "Jan 23", "Jan 24", "Jan 25",
                "Jan 26", "Jan 24", "Jan 28", "Jan 29"
              ],
              axisBorder: {
                show: !1
              },
  ...
  return {
    init: function() {
      ...
      r(l, "#kt_charts_widget_10_tab_4", "#kt_charts_widget_10_chart_4", n, !1), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r(e,
          "#kt_charts_widget_10_tab_1", "#kt_charts_widget_10_chart_1", o, e.rendered), r(t, "#kt_charts_widget_10_tab_2",
          "#kt_charts_widget_10_chart_2", i, t.rendered), r(a, "#kt_charts_widget_10_tab_3", "#kt_charts_widget_10_chart_3", s, a.rendered), r(l,
          "#kt_charts_widget_10_tab_4", "#kt_charts_widget_10_chart_4", n, l.rendered)
      }))
    }
  }
}();
      ...
      if (o) {
        var s = KTUtil.getCssVariableValue("--bs-gray-500"),
          ...
          m = {
            ...
            xaxis: {
              categories: ["", "Apr 02", "Apr 06", "Apr 06", "Apr 05", "Apr 06", "Apr 10", "Apr 08", "Apr 09", "Apr 14", "Apr 10", "Apr 12", "Apr 18",
                "Apr 14", "Apr 15", "Apr 14", "Apr 17", "Apr 18", "Apr 02", "Apr 06", "Apr 18", "Apr 05", "Apr 06", "Apr 10", "Apr 08", "Apr 22", "Apr 14",
                "Apr 11", "Apr 12", ""
              ],
              axisBorder: {
                show: !1
  ...
  return {
    init: function() {
      ...
      l(a, "#kt_charts_widget_11_tab_3", "#kt_charts_widget_11_chart_3", i, !0), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l(e, "#kt_charts_widget_11_tab_1",
          "#kt_charts_widget_11_chart_1", r, e.rendered), l(t, "#kt_charts_widget_11_tab_2", "#kt_charts_widget_11_chart_2", o, t.rendered), l(a,
          "#kt_charts_widget_11_tab_3", "#kt_charts_widget_11_chart_3", i, a.rendered)
      }))
    }
  }
}();
...
var KTChartsWidget12 = function() {
  ...
  return {
    init: function() {
      e("#kt_charts_widget_12_tab_1", "#kt_charts_widget_12_chart_1", [54, 42, 75, 110, 23, 87, 50], !0), e("#kt_charts_widget_12_tab_2",
        "#kt_charts_widget_12_chart_2", [25, 55, 35, 50, 45, 20, 31], !1), e("#kt_charts_widget_12_tab_3", "#kt_charts_widget_12_chart_3", [45, 15, 35,
        70, 45, 50, 21
      ], !1)
    }
  }
        ...
        if (e) {
          var t, a = function() {
            ...
            o.get("renderer").grid.template.setAll({
              ...
              fontSize: 13,
              fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))
            }), i("Cars", "cars", KTUtil.getCssVariableValue("--bs-primary")), i("Motorcycles", "motorcycles", KTUtil.getCssVariableValue(
              "--bs-success")), i("Bicycles", "bicycles", KTUtil.getCssVariableValue("--bs-warning")), a.set("scrollbarX", am5.Scrollbar.new(t, {
      ...
      if (t) {
        var a = parseInt(KTUtil.css(t, "height")),
          ...
          s = {
            ...
            xaxis: {
              categories: ["", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13",
...
var KTChartsWidget22 = function() {
  var e = function(e, t, a, l) {
    ...
    if (r) {
      ...
      var o = {
          ...
          colors: [KTUtil.getCssVariableValue("--bs-info"), KTUtil.getCssVariableValue("--bs-success"), KTUtil.getCssVariableValue("--bs-primary"), KTUtil
  ...
  return {
    init: function() {
      e("#kt_chart_widgets_22_tab_1", "#kt_chart_widgets_22_chart_1", [20, 100, 15, 25], !0), e("#kt_chart_widgets_22_tab_2",
        "#kt_chart_widgets_22_chart_2", [70, 13, 11, 2], !1)
    }
  }
}();
        ...
        if (e) {
          var t, a = function() {
            ...
            h.mapPolygons.template.setAll({
              ...
              for (var t = e.target.dataItem.dataContext.id.split("-").pop(), a = r(l[t]), o = 0; o < a.length; o++) m.data.setIndex(o, a[o]), c
                .data.setIndex(o, a[o]);
      ...
      if (t) {
        var a = parseInt(KTUtil.css(t, "height")),
          ...
          i = {
            ...
            xaxis: {
              categories: ["May 04", "May 05", "May 06", "May 09", "May 10", "May 12", "May 14", "May 17", "May 18", "May 20", "May 22", "May 24", "May 26",
                "May 28", "May 30"
              ],
              axisBorder: {
                show: !1
      ...
      if (t) {
        var a = parseInt(KTUtil.css(t, "height")),
          ...
          i = {
            ...
            xaxis: {
              categories: ["Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 09", "Apr 10", "Apr 12", "Apr 14", "Apr 17", "Apr 18", "Apr 18", "Apr 20",
                "Apr 22", "Apr 24"
              ],
              axisBorder: {
                show: !1
  ...
  return {
    init: function() {
      ...
      l(a, "#kt_charts_widget_32_tab_3", "#kt_charts_widget_32_chart_3", i, !1), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l(e, "#kt_charts_widget_32_tab_1",
          "#kt_charts_widget_32_chart_1", r, e.rendered), l(t, "#kt_charts_widget_32_tab_2", "#kt_charts_widget_32_chart_2", o, t.rendered), l(a,
          "#kt_charts_widget_32_tab_3", "#kt_charts_widget_32_chart_3", i, a.rendered)
      }))
    }
  }
}();
  ...
  return {
    init: function() {
      ...
      var n = [2300, 2300, 2e3, 3200, 3200, 2800, 2400, 2400, 3100, 2900, 3100, 3100, 2600, 2600, 3200],
        d = ["Apr 01", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14",
          "Apr 15"
        ];
      ...
      var m = [2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3200, 3200, 2600, 3100, 2800, 2400, 2400],
        c = ["Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 09", "Apr 10", "Apr 12", "Apr 14", "Apr 17", "Apr 18", "Apr 18", "Apr 20", "Apr 22",
          "Apr 24"
        ];
      ...
      var g = [1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3300, 2400, 2400, 3e3, 3200, 3100],
        f = ["Jun 2021", "Jul 2021", "Aug 2021", "Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022",
      ...
      var u = [3e3, 2100, 3300, 3100, 1800, 1800, 2400, 2400, 3100, 3100, 2400, 2400, 3e3, 2400, 2800],
        h = ["Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022",
      ...
      o(r, "#kt_charts_widget_33_tab_5", "#kt_charts_widget_33_chart_5", u, h, !1), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered &&
          r.self.destroy(), o(e, "#kt_charts_widget_33_tab_1", "#kt_charts_widget_33_chart_1", i, s, e.rendered), o(t, "#kt_charts_widget_33_tab_2",
            "#kt_charts_widget_33_chart_2", n, d, t.rendered), o(a, "#kt_charts_widget_33_tab_3", "#kt_charts_widget_33_chart_3", m, c, a.rendered),
          o(l, "#kt_charts_widget_33_tab_4", "#kt_charts_widget_33_chart_4", g, f, l.rendered), o(r, "#kt_charts_widget_33_tab_5",
            "#kt_charts_widget_33_chart_5", u, h, r.rendered)
      }))
    }
  }
}();
  ...
  return {
    init: function() {
      ...
      o(r, "#kt_charts_widget_34_tab_5", "#kt_charts_widget_34_chart_5", u, h, !1), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered &&
          r.self.destroy(), o(e, "#kt_charts_widget_34_tab_1", "#kt_charts_widget_34_chart_1", i, s, e.rendered), o(t, "#kt_charts_widget_34_tab_2",
            "#kt_charts_widget_34_chart_2", n, d, t.rendered), o(a, "#kt_charts_widget_34_tab_3", "#kt_charts_widget_34_chart_3", m, c, a.rendered),
          o(l, "#kt_charts_widget_34_tab_4", "#kt_charts_widget_34_chart_4", g, f, l.rendered), o(r, "#kt_charts_widget_34_tab_5",
            "#kt_charts_widget_34_chart_5", u, h, r.rendered)
      }))
    }
  }
}();
  ...
  return {
    init: function() {
      ...
      o(r, "#kt_charts_widget_35_tab_5", "#kt_charts_widget_35_chart_5", u, h, !1), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered &&
          r.self.destroy(), o(e, "#kt_charts_widget_35_tab_1", "#kt_charts_widget_35_chart_1", i, s, e.rendered), o(t, "#kt_charts_widget_35_tab_2",
            "#kt_charts_widget_35_chart_2", n, d, t.rendered), o(a, "#kt_charts_widget_35_tab_3", "#kt_charts_widget_35_chart_3", m, c, a.rendered),
          o(l, "#kt_charts_widget_35_tab_4", "#kt_charts_widget_35_chart_4", g, f, l.rendered), o(r, "#kt_charts_widget_35_tab_5",
      ...
      if (t) {
        var a = parseInt(KTUtil.css(t, "height")),
          ...
          n = {
            ...
            xaxis: {
              categories: ["", "8 AM", "81 AM", "9 AM", "10 AM", "11 AM", "12 PM", "13 PM", "14 PM", "15 PM", "16 PM", "17 PM", "18 PM", "18:20 PM",
                "18:20 PM", "19 PM", "20 PM", "21 PM", ""
              ],
              axisBorder: {
                show: !1
              },
  ...
  return {
    init: function() {
      ...
      var s = [2300, 2300, 2e3, 3200, 3200, 2800, 2400, 2400, 3100, 2900, 3100, 3100, 2600, 2600, 3200],
        n = ["Apr 01", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14",
          "Apr 15"
        ];
      ...
      var d = [2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3200, 3200, 2600, 3100, 2800, 2400, 2400],
        m = ["Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 09", "Apr 10", "Apr 12", "Apr 14", "Apr 17", "Apr 18", "Apr 18", "Apr 20", "Apr 22",
          "Apr 24"
        ];
      ...
      var c = [1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3300, 2400, 2400, 3e3, 3200, 3100],
        g = ["Jun 2021", "Jul 2021", "Aug 2021", "Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022",
          "Jun 2022", "Jul 2022", "Aug 2022"
        ];
      r(l, "#kt_charts_widget_37_tab_4", "#kt_charts_widget_37_chart_4", c, g, !1), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r(e,
            "#kt_charts_widget_37_tab_1", "#kt_charts_widget_37_chart_1", o, i, e.rendered), r(t, "#kt_charts_widget_37_tab_2",
            "#kt_charts_widget_37_chart_2", s, n, t.rendered), r(a, "#kt_charts_widget_37_tab_3", "#kt_charts_widget_37_chart_3", d, m, a.rendered),
  ...
  return {
    init: function() {
      ...
      o(r, "#kt_charts_widget_41_tab_5", "#kt_charts_widget_41_chart_5", u, h, !1), KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered &&
          r.self.destroy(), o(e, "#kt_charts_widget_41_tab_1", "#kt_charts_widget_41_chart_1", i, s, e.rendered), o(t, "#kt_charts_widget_41_tab_2",
            "#kt_charts_widget_41_chart_2", n, d, t.rendered), o(a, "#kt_charts_widget_41_tab_3", "#kt_charts_widget_41_chart_3", m, c, a.rendered),
          o(l, "#kt_charts_widget_41_tab_4", "#kt_charts_widget_41_chart_4", g, f, l.rendered), o(r, "#kt_charts_widget_41_tab_5",
            "#kt_charts_widget_41_chart_5", u, h, r.rendered)
      }))
    }
  }
}();
      ...
      if (t) {
        var a = parseInt(KTUtil.css(t, "height")),
          ...
          s = {
            ...
            xaxis: {
              categories: ["", "29 Sep", "1 Aug", "2 Aug", "3 Aug", "4 Aug", "5 Aug", "6 Aug", "7 Aug", "8 Aug", "9 Aug", "10 Aug", "11 Aug", "12 Aug",
      ...
      if (t) {
        var a = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
          l = {
            series: [{
              name: "Commission",
              data: [12000, 9000, 4500, 2400, 950, 430, 120, 55, 25],
              show: !1
            }],
            chart: {
              type: "bar",
            ...
            colors: ["#3E97FF", "#F1416C", "#50CD89", "#FFC700", "#7239EA", "#50CDCD", "#3F4254", "#F1416C", "#50CD89"],
            xaxis: {
              categories: ["US", "UK", "AU", "DE", "FR", "NL", "IT", "ES", "BE"],
              labels: {
                formatter: function(e) {
                  return e + "K"
                },
...
var KTChartsWidget8 = function() {
      ...
      if (o) {
        var i = parseInt(KTUtil.css(o, "height")),
          ...
          n = {
            ...
            colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-success"), KTUtil.getCssVariableValue("--bs-warning"),
              KTUtil.getCssVariableValue("--bs-danger"), KTUtil.getCssVariableValue("--bs-info"), "#43CED7"
            ],
            fill: {
              opacity: 1
            },
  ...
  return {
    init: function() {
      ...
      a(e, "#kt_chart_widget_8_week_toggle", "#kt_chart_widget_8_week_chart", l, !1), a(t, "#kt_chart_widget_8_month_toggle",
        "#kt_chart_widget_8_month_chart", r, !0);
      KTThemeMode.on("kt.thememode.change", (function() {
        e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a(e, "#kt_chart_widget_8_week_toggle", "#kt_chart_widget_8_week_chart", l, e
          .rendered), a(t, "#kt_chart_widget_8_month_toggle", "#kt_chart_widget_8_month_chart", r, t.rendered)
      }))
    }
  }
}();
...
var KTTimelineWidget2 = {
  init: function() {
    ...
    (e = document.querySelector("#kt_timeline_widget_2_card")) && KTUtil.on(e, '[data-kt-element="checkbox"]', "change", (function(e) {
      ...
      !0 === this.checked ? (t.classList.add("form-check-success"), l.classList.remove("bg-primary"), l.classList.add("bg-success"), r.innerText =
        "Done", r.classList.remove("badge-light-primary"), r.classList.add("badge-light-success")) : (t.classList.remove("form-check-success"), l
        .classList.remove("bg-success"), l.classList.add("bg-primary"), r.innerText = "In Process", r.classList.remove("badge-light-success"), r
        .classList.add("badge-light-primary"))
    }))
  }
};
